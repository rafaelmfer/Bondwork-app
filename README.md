...
![Representation of Geometric shapes B and W forming the Logo](https://github.com/rafaelmfer/Bondwork-app/blob/main/screenshots/Logo_explanation.png)
...
<table>  
    ...
    <tr>
        <td>
            <img src="https://github.com/rafaelmfer/Bondwork-app/blob/main/screenshots/LandingPageDesktop.png"/>
        </td>
        <td>
            <img src="https://github.com/rafaelmfer/Bondwork-app/blob/main/screenshots/LandingPageMobile.png" width=270/>
        </td>
    </tr>
</table>
...
<table>  
    ...
    <tr>
        <td>
            <img src="https://github.com/rafaelmfer/Bondwork-app/blob/main/screenshots/LoginDesktop.png"/>
        </td>
        <td>
            <img src="https://github.com/rafaelmfer/Bondwork-app/blob/main/screenshots/LoginMobile.png" width=750/>
        </td>
    </tr>
</table>
...
<table>  
    ...
    <tr>
        <td>
            <img src="https://github.com/rafaelmfer/Bondwork-app/blob/main/screenshots/SignupDesktop.png"/>
        </td>
        <td>
            <img src="https://github.com/rafaelmfer/Bondwork-app/blob/main/screenshots/SignupMobile.png" width=500/>
        </td>
    </tr>
</table>
...
<table>  
    ...
    <tr>
        <td>
            <img src="https://github.com/rafaelmfer/Bondwork-app/blob/main/screenshots/Dashboard.png"/>
        </td>
        <td>
            <img src="https://github.com/rafaelmfer/Bondwork-app/blob/main/screenshots/RecognitionsPage.png"/>
        </td>
    </tr>
</table>
...
<table>  
    ...
    <tr>
        <td>
            <img src="https://github.com/rafaelmfer/Bondwork-app/blob/main/screenshots/RewardsPage.png"/>
        </td>
        <td>
            <img src="https://github.com/rafaelmfer/Bondwork-app/blob/main/screenshots/SurveyPage.png"/>
        </td>
    </tr>
</table>
...
- [Dictionary/Glossary](https://github.com/rafaelmfer/Bondwork-app/blob/main/backend/docs/database_glossary.md)
- [EDR Diagram](https://github.com/rafaelmfer/Bondwork-app/blob/main/backend/docs/DatabaseStructure.png)